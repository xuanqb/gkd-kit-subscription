    ...
    groups: [
      {
        ...
        rules: [
          ...
          '[text="BOSS活跃度低"]',
          '[text="面试过/入职过"]',
          '[id="com.hpbr.bosszhipin:id/boss_label_tv"][text="本周活跃"||text="本月活跃"||text="近半年活跃"||text="半年前活跃"||text$="周内活跃"||text$="月内活跃"] <n ViewGroup <n RecyclerView < FrameLayout <n ViewPager < RelativeLayout > FrameLayout[id="com.hpbr.bosszhipin:id/title_action_view"] >n [id="com.hpbr.bosszhipin:id/iv_another"]'
        ],
      },
    ],
  }
